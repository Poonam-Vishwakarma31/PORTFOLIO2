...
export function ProjectCard({title, description, techStack, image, githubLink}) {
  ...
  return (
    <div className="border-2 border-[#2D2540] bg-[#1A1625] rounded-lg p-4 w-80 hover:scale-105 transition-transform duration-300">
        ...
        <p className="text-gray-300 mb-4">{description}</p>
            ...
            <div className="mt-8">
                <a href={githubLink} target="_blank" rel="noopener noreferrer" className="text-white text-2xl hover:text-black">
                   <FaGithub />
                </a>
            </div>
    </div>
